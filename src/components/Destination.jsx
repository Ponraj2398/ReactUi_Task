            ...
            <div className="flex flex-wrap items-center py-8 responsive-columns">
                ...
                <div className="w-full md:w-3/12 carousel-btn space-x-4">
                    ...
                    <button
                        ...
                        data-carousel-next
                    >
                        <span className="inline-flex items-center justify-center w-20 h-20 rounded-full text-white group-hover:bg-blue-600 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70">
                            <svg
                                className="w-7 h-7 group-hover:text-white"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
